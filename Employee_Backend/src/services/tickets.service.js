...
class TicketService {
    ...
    async updateTicket(id, ticketData, token) {
        try {
            ...
            const userResponse = await axios.get(`http://18.209.26.169:8080/api/customers/${ticket.customerId}`, {
                httpsAgent,
                headers: {
            ...
            await axios.post(`http://18.209.26.169:7000/api/email`, emailData, {
                httpsAgent,
                headers: {
                    'Content-Type': 'application/json'
                }
            ...
            await axios.get(`http://18.209.26.169:8000/api/employees/${ticket.employeeId}/stats`, {
                httpsAgent,
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
            ...
            const employee = await axios.get(`http://18.209.26.169:8000/api/employees/${ticket.employeeId}`,{
                httpsAgent,
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
            ...
            await axios.get(`http://18.209.26.169:5000/api/managers/${employee.data.managerId}/stats`, {
                httpsAgent,
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
